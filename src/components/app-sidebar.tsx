                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton 
                    ...
                    className={cn(
                      ...
                      location.pathname.startsWith(item.url) ? "bg-gray-800 font-semibold" : ""
                    )}
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  className="text-white hover:bg-red-600/20 hover:text-red-500 transition-colors"
