  ...
  return <MainLayout>
      <div className="space-y-6">
              ...
              <DialogContent>
                ...
                <div className="space-y-4 py-4">
                  <div className="space-y-2">
                    ...
                    <Input id="username" value={newUser.username} onChange={e => setNewUser(prev => ({
                    ...prev,
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="password" type="password" value={newUser.password} onChange={e => setNewUser(prev => ({
                    ...prev,
                    password: e.target.value
                  }))} />
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="isAdmin" checked={newUser.isAdmin} onCheckedChange={checked => setNewUser(prev => ({
                    ...prev,
                    isAdmin: !!checked
                  }))} />
        ...
        <Card>
          ...
          <CardContent>
            {users.length === 0 ? <div className="text-center p-6">
                ...
                <TableBody>
                  {users.map(user => <TableRow key={user.id}>
                      ...
                      <TableCell>
                        {currentUser?.id !== user.id && <AlertDialog>
